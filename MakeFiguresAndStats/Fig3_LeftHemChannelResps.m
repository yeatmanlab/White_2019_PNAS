%% Figure 3 for White, Palmer, Boynton & Yeatman, PNAS 2019
% Makes a bar plot of mean channel responses left hemisphere VWFAs.
...
%
function Fig3_LeftHemChannelResps()
...
hemI = find(strcmp(allR.valsByIndex.hemisphere,'Left'));
nHems = length(hemI);
...
figTitle = fullfile(p.figures,sprintf('Fig3_ChannelResps_%sHem.eps',hemLab));
